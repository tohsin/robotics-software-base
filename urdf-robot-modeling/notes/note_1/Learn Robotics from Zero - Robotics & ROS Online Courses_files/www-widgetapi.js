...
nf.prototype.reset=function(){this.next=this.scope=this.i=null};function of(a,b){pf||qf();rf||(pf(),rf=!0);Pf.add(a,b)}
var pf;function qf(){if(A.Promise&&A.Promise.resolve){var a=A.Promise.resolve(void 0);pf=function(){a.then(Qf)}}else pf=function(){var b=Qf;
...
var rf=!1,Pf=new lf;function Qf(){for(var a;a=Pf.remove();){try{a.i.call(a.scope)}catch(b){Rc(b)}hf(mf,a)}rf=!1}
...
jg.prototype.$goog_Thenable=!0;jg.prototype.cancel=function(a){if(0==this.i){var b=new pg(a);of(function(){qg(this,b)},this)}};
...
function ug(a){a.A||(a.A=!0,of(a.D,a))}
...
function wg(a,b){a.m=!0;of(function(){a.m&&yg.call(null,b)})}
