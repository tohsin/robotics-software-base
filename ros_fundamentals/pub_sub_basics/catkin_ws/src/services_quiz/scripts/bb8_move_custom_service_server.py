...
my_service = rospy.Service('/move_bb8_in_square_custom', BB8CustomServiceMessage , callback) # create the Service called move_bb8_in_square with the defined callback
